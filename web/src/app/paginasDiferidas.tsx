...
export const ClientesListaPage = lazy(() =>
  import('../features/admin/clientes/ClientesListaPage').then((modulo) => ({
    default: modulo.ClientesListaPage,
  })),
);
export const ClienteNuevoPage = lazy(() =>
  import('../features/admin/clientes/ClienteNuevoPage').then((modulo) => ({
    default: modulo.ClienteNuevoPage,
  })),
);
export const ClienteDetallePage = lazy(() =>
  import('../features/admin/clientes/ClienteDetallePage').then((modulo) => ({
    default: modulo.ClienteDetallePage,
  })),
);
export const TrabajadoresPage = lazy(() =>
  import('../features/trabajadores/TrabajadoresPage').then((modulo) => ({
    default: modulo.TrabajadoresPage,
  })),
);
export const AvicolaInicioPage = lazy(() =>
  import('../features/avicola/AvicolaInicioPage').then((modulo) => ({
    default: modulo.AvicolaInicioPage,
  })),
);
export const GalponesPage = lazy(() =>
  import('../features/avicola/GalponesPage').then((modulo) => ({ default: modulo.GalponesPage })),
);
export const GalponPage = lazy(() =>
  import('../features/avicola/GalponPage').then((modulo) => ({ default: modulo.GalponPage })),
);
export const EficienciaPage = lazy(() =>
  import('../features/avicola/EficienciaPage').then((modulo) => ({
