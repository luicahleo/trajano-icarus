...
{
    /// <inheritdoc />
    public partial class NotificacionesDespachoHuevo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "notificaciones_internas_despacho_huevo",
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_notificaciones_internas_despacho_huevo", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_notificaciones_internas_despacho_huevo_ClienteId_FechaUtc",
                schema: "gestion_avicola",
                table: "notificaciones_internas_despacho_huevo",
                columns: new[] { "ClienteId", "FechaUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_notificaciones_internas_despacho_huevo_DespachoHuevoId",
                schema: "gestion_avicola",
                table: "notificaciones_internas_despacho_huevo",
