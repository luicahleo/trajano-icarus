...
- [ ] **Step 1: Paquetes y FrameworkReference en Clientes.Infrastructure**
...
- [ ] **Step 2: Referencias de proyecto en Host y tests**
...
- [ ] **Step 3: Verificar restore real con caché limpio y build**
...
- [ ] **Step 5: Implementación — Trabajador**
...
- [ ] **Step 6: Borrar el marcador y actualizar los tests de arquitectura**
...
- [ ] **Step 3: Implementación — contrato de entitlement**
...
- [ ] **Step 4: Implementación — Clientes (repositorio, comandos, handlers, validadores)**
...
- [ ] **Step 5: Implementación — Trabajadores (repositorio, comandos, handlers, validadores)**
...
- [ ] **Step 6: Borrar el marcador y actualizar el test de arquitectura**
...
- [ ] **Step 1: Persistencia — ClientesDbContext con filtros globales**
...
- [ ] **Step 3: Entitlement — requisito, handler, políticas y verificador**
...
- [ ] **Step 4: DI, factory de diseño y semilla**
...
- [ ] **Step 5: Política `GestionTrabajadores` en Identity y limpieza del registro muerto de IUnitOfWork**
...
- [ ] **Step 6: Extender los tests de arquitectura**
...
- [ ] **Step 8: Generar la migración inicial de Clientes**
...
- [ ] **Step 2: Crear los endpoints de clientes y trabajadores**
...
- [ ] **Step 4: Verificación manual en desarrollo (Docker disponible)**
...
- [ ] **Step 1: Escribir los tests de endpoints de clientes**
...
- [ ] **Step 2: Escribir los tests de trabajadores (tenant y soft delete)**
...
- [ ] **Step 3: Escribir los tests de entitlement (sondeo)**
